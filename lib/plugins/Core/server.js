...
var Server = function (_BaseCommand) {
  _inherits(Server, _BaseCommand);
  ...
  _createClass(Server, [{
    ...
    value: function handle() {
      this.reply([':wrench: Looking for support? My support channel is here:', '**https://discord.gg/0xyZL4m5TyYTzVGY**'].join('\n'));
    }
  }, {
    key: 'name',
    get: function get() {
